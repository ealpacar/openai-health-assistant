...
* Needs a working OpenAI API Key.
* Rate limits problems still do exist in free-plan
* app.py is added later to create an UI.
Its, demo, made with some (especially ui/dl part) help from Claude AI.
